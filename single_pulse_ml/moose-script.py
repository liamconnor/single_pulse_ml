...
train_set = bool(sys.argv[1]) # Creates training set if True, creates test set if False
run_predict = bool(sys.argv[2]) # Applies saved fit, makes predictions on test data if True
...
for fn in file_list:
    ...
    data = reader.rebin_arr(data, 64, 250) 
